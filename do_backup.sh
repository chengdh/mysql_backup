...
#每周日 周2 周4 早上4点作全备份
#每天早上4点作增量备份
if [ `date +%A` = "Sunday" -o `date +%A` = "Tuesday" -o `date +%A` = "Thursday"  -a `date +%H` = "04" -o "$1" = "dump" ]; then
